...
/**
 * UI Audit Slice 4 (2026-04-28) — Comms hub layout.
 *
 * Drafts (default) · Published. Notifications log subtab is scaffolded
 * once the dedicated UI lands.
 */

export const dynamic = "force-dynamic";

const HUB = ADMIN_HUBS.find((h) => h.key === "comms")!;
...
export default async function AnnouncementsLayout({
  ...
  const { data: pub } = await userClient
    ...
    .maybeSingle();
  if (!pub) redirect("/login?next=/admin/announcements");
  ...
  return (
    <div className="space-y-6" data-testid="announcements-shell">
      <Breadcrumbs />
