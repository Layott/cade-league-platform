...
export default async function OverlayV2Page({
  ...
  // SSR pre-seed reverted 2026-05-11 to stay under Vercel Hobby compute
  // cap. Client-side fetch via OverlayDataInjector against the now
  // CDN-cached endpoints (s-maxage=60) restores live data with ~100-300ms
  // delay after iframe load. The cade-visible class still gates
  // visibility so the slight delay never shows on stream.
